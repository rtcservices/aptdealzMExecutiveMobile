...
#pragma warning disable CS0618 // Type or member is obsolete
    public class RingtoneManagerService : IRingtoneManager
    {
        ...
        //        var uid = activity.ApplicationInfo.Uid;
        //        Intent settingsIntent = new Intent(Android.Provider.Settings.ActionAppNotificationSettings);
        //        settingsIntent.PutExtra(Android.Provider.Settings.ExtraAppPackage, packageName);
        //        settingsIntent.PutExtra(Android.Provider.Settings.ExtraChannelId, uid);
        //        activity.SetResult(Android.App.Result.Ok, settingsIntent);
        //        activity.StartActivityForResult(settingsIntent, 5);
        //    }
        //    catch (Exception ex)
        //    {
        //        Common.DisplayErrorMessage("RingtoneManagerService/OpenNotificationSettings: " + ex.Message);
        //    }
        ...
        //    try
        //    {
        //        var isPlay = InstanceStopPlaying();
        //        if (isPlay)
        //            return;
        ...
        //        {
        //            var mRingToneuri = alarms.Where(x => x.LastPathSegment == Id.ToString()).FirstOrDefault();
        //            Android.Media.Ringtone osRingtone = RingtoneManager.GetRingtone(activity, mRingToneuri);
        //            osRingtone.Stop();
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        //        Common.DisplayErrorMessage("RingtoneManagerService/StopRingTone: " + ex.Message);
        //    }
        //}
